...
Solid Stats — это инженерная сторона сообщества Solid Games: платформа статистики
матчей и инструменты, на которых живут операции сообщества. Записи миссий OCAP
превращаются в честную пер-игровую статистику — для каждой операции.
...
Solid Stats разрабатывается **от и до AI-агентами** по процессу **GSD** — структурированному
пошаговому циклу (explore → spec → plan → execute → review → verify → ship). Люди задают
направление и принимают результат; агенты — строят. У каждого репозитория свой каталог
`.planning/`, а общие инженерные стандарты лежат в
...
| [`plans`](https://github.com/solid-stats/plans) | — | Продуктовое и стратегическое планирование |
| [`skills`](https://github.com/solid-stats/skills) | — | Общие инженерные стандарты для AI-агентов |

> Текущая платформа — Solid Stats 2. Предыдущее поколение
